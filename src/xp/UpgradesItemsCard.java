...
public class UpgradesItemsCard {
    ...
    public void createUpgrades() {
        ...
        cards.add(new Card(id++, "True POWER", "All towers deal TRUE damage, but they have More HP", true, -2));
        ...
        cards.add(new Card(id++, "Strong Canon", "CANNON will now exploding 2 times", true, 1));
        //FROST_MAGE
        ...
        cards.add(new Card(id++, "Two for One", "Mine Factory will now sets 2 mines at the time", true, 3));
        cards.add(new Card(id++, "Big Mines", "Mine Factory will now sets mines that du more damage", true, 3));
        //POISON_TOWER
